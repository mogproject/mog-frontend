...
case object SVGStandardLayout extends SVGAreaLayout {
  ...
  override def player: SVGPlayerLayout = SVGPlayerLayout(
    ...
    Rect(Coord(boardMargin + handWidth, whiteHandTopLeft.y), playerWidth, handPieceHeight - playerNameHeight + 15),
    Seq(
    ...
    Rect(Coord(boardMargin, blackHandTopLeft.y + playerNameHeight - 15), playerWidth, handPieceHeight - playerNameHeight + 15),
    Seq(
