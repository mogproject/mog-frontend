...
trait EventManageable {
  ...
  /**
    ...
    */
  def registerTouchStart(elem: Element, f: TouchEvent => Unit): Unit = if (hasTouchEvent) {
  ...
  /**
    ...
    */
  def registerTouchCancel(elem: Element): Unit = if (hasTouchEvent) {
  ...
  /**
    ...
    */
  def registerMouseDown(elem: Element, f: MouseEvent => Unit): Unit = {
  ...
  /**
    ...
    * @note Reacts only to the left click. (button == 0)
    */
  def registerMouseUp(elem: Element, f: MouseEvent => Unit): Unit = {
  ...
  /**
    ...
    * @note Reacts only to the left click. (button == 0)
    */
  def registerMouseOut(elem: Element): Unit = {
    elem.addEventListener("mouseout", withCommonWrapper()(nullEvent), useCapture = false)
  }

  /**
    * Register 'mousemove' event
    */
  def registerMouseMove(elem: Element, f: MouseEvent => Unit): Unit = {
    elem.addEventListener("mousemove", f, useCapture = false)
  }


  def setClickEvent(elem: Element, onClick: () => Unit, onHold: Option[() => Unit] = None, checker: Option[() => Boolean] = None): Unit = {
